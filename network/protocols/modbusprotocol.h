...
class NewModbusProtocol : public QObject, public NewSoftProtocol {
    Q_OBJECT
public:
    ...
    explicit NewModbusProtocol(QObject* parent = nullptr);
    ~NewModbusProtocol() override;
...
Q_DECLARE_OPERATORS_FOR_FLAGS(NewModbusProtocol::CommandsType)
