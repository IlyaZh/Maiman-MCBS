...
void ReadParameterWidget::setup(QStringView name,
  ...
  if (m_command) {
    ...
    connect(m_command.get(), &DevCommand::updatedUnit, this,
            [this](QStringView unit) { setUnit(unit.toString()); });
  }
