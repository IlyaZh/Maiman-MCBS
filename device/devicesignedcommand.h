...
{
public:
    explicit DeviceSignedCommand(QString code, QString unit = "", double divider = 1, quint8 interval = 1, quint8 tol = 0, bool isTemperature = false, quint16 maxInterval = MAX_COM_INTERVAL_COUNTER, QObject* parent = nullptr);
