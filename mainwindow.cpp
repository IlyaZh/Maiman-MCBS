      ...
      m_settings(new AppSettings(this))
{
    ...
    if(netData.type != MainWindowController::UNKNOWN_PROTOCOL) {
...
{
    if(m_cntrl != nullptr) {
        m_cntrl->networkConnectClicked(MainWindowController::TCP_PROTOCOL, ui->ipLineEdit->text(), ui->portSpinBox->value());

        if(m_settings != nullptr) {
            NetworkData_s netData;
            netData.type = MainWindowController::TCP_PROTOCOL;
